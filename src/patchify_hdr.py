...
def main():
    ...
    opt['save_folder'] = '/home/luoleyouluole/Image-Restoration-Experiments/data/240p_valid_patchify'
    opt['crop_size'] = 960
    opt['step'] = 480
    opt['thresh_size'] = 0
    ...
    opt['save_folder'] = '/home/luoleyouluole/Image-Restoration-Experiments/data/240p_valid_4xd_patchify'
    opt['crop_size'] = 240
    opt['step'] = 120
    opt['thresh_size'] = 0
    extract_subimages(opt)
