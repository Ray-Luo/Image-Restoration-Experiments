...
for file_name in tqdm(test_imgs):
    ...
    test_names = [
        file_name.replace("_raw_GT", "").replace("_exr2hdr_", "_noise_exr2hdr_"),
...
with open("/home/luoleyouluole/Image-Restoration-Experiments/src/report_sad_complete.txt", "w") as file:
    file.write(report)
